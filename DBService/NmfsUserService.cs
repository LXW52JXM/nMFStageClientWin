...
namespace DBService
{
    public class NmfsUserService
    {
        private static readonly nmfs_userManager EntityMgr = new nmfs_userManager();

        /// <summary>
        /// 得到实体类转成Dic
        /// </summary>
        private static Dictionary<string, object> EntityMap = ToMap(new nmfs_user());
        ...
        /// </summary>
        /// <returns></returns>
        public static nmfs_user GetOneDataByPrimaryKey(object o)
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_user>()
                    .InSingle(o);
                return res;
            }
            catch (Exception ex)
        ...
        /// </summary>
        /// <returns></returns>
        public static List<nmfs_user> GetDataByNumber(int maxUpDataCount)
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_user>()
        ...
        /// </summary>
        /// <returns></returns>
        public static List<nmfs_user> GetData()
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_user>()
        ...
        /// <returns></returns>
        public static List<nmfs_user> GetDataByEntity(nmfs_user entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static List<nmfs_user> GetDataByDic(Dictionary<string, object> queryValue, ConditionalType conditionalType = ConditionalType.Equal)
        {
            try
            {
                ...
                var res = EntityMgr.Db.Queryable<nmfs_user>().Where(conModels)
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static List<nmfs_user> GetPageDataByEntity(int currentPageIndex, int pageSize, ref int totalCount, nmfs_user entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static List<nmfs_user> GetPageDataByDic(int currentPageIndex, int pageSize, ref int totalCount, Dictionary<string, object> queryValue, ConditionalType conditionalType = ConditionalType.Equal)
        {
            try
            {
                List<IConditionalModel> conModels = new List<IConditionalModel>();
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static bool Insert(nmfs_user entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static bool InsertByList(List<nmfs_user> entityList)
        {
            try
            {
        ...
        public static bool Save(nmfs_user entity)
        {
            try
            {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static bool Update(nmfs_user entity)
        {
            try
            {
        ...
        public static bool DeletePrimaryKey(object primaryKeyValue)
        {
            try
            {
                var res = EntityMgr.Db.Deleteable<nmfs_user>().In(primaryKeyValue).ExecuteCommand();
                return res > 0;
            }
            catch (Exception ex)
            {
        ...
        public static bool DeletePrimaryKey(object[] primaryKeyValueArray)
        {
            try
            {
                var res = EntityMgr.Db.Deleteable<nmfs_user>().In(primaryKeyValueArray).ExecuteCommand();
                return res > 0;
            }
            catch (Exception ex)
            {
        ...
        /// <param name="strArray"></param>
        /// <returns></returns>
        public static bool DeleteByEntity(nmfs_user entity)
        {
            try
            {
        ...
        public static bool DeleteByDic(Dictionary<string, object> queryValue)
        {
            try
            {
                ...
                var res = EntityMgr.Db.Deleteable<nmfs_user>()
                    .Where(queryWhereStr)
                  .ExecuteCommand();
                return res > 0;
            }
        ...
        public static bool DeleteAll()
        {
            try
            {
                var res = EntityMgr.Db.DbMaintenance.TruncateTable<nmfs_user>();
                return res;
            }
            catch (Exception ex)
            {
        ...
        /// <returns>备注</returns>
        public static bool IsExistSingleDataByEntity(nmfs_user entity, out nmfs_user returnEntity)
        {
            try
            {
                returnEntity = new nmfs_user();
                List<IConditionalModel> conModels = new List<IConditionalModel>();
        ...
        public static nmfs_user UserLoginAccount(string account)
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_user>()
            ...
            {
                throw new Exception("数据库操作失败：" + ex.ToString());
            }
        }

        public static nmfs_user UserLogin(string account, string password)
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_user>()
                    .Where(it => it.account == account)
                     .Where(it => it.password == password)
                     .ToList();
                if (res.Count == 1)
                {
                    return res.First();
