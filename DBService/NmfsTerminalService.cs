...
namespace DBService
{
    public class NmfsTerminalService
    {
        private static readonly nmfs_terminalManager EntityMgr = new nmfs_terminalManager();

        /// <summary>
        /// 得到实体类转成Dic
        /// </summary>
        private static Dictionary<string, object> EntityMap = ToMap(new nmfs_terminal());
        ...
        /// </summary>
        /// <returns></returns>
        public static nmfs_terminal GetOneDataByPrimaryKey(object o)
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_terminal>()
                    .InSingle(o);
                return res;
            }
            catch (Exception ex)
        ...
        /// </summary>
        /// <returns></returns>
        public static List<nmfs_terminal> GetDataByNumber(int maxUpDataCount)
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_terminal>()
        ...
        /// </summary>
        /// <returns></returns>
        public static List<nmfs_terminal> GetData()
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_terminal>()
        ...
        /// <returns></returns>
        public static List<nmfs_terminal> GetDataByEntity(nmfs_terminal entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static List<nmfs_terminal> GetDataByDic(Dictionary<string, object> queryValue, ConditionalType conditionalType = ConditionalType.Equal)
        {
            try
            {
                ...
                var res = EntityMgr.Db.Queryable<nmfs_terminal>().Where(conModels)
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static List<nmfs_terminal> GetPageDataByEntity(int currentPageIndex, int pageSize, ref int totalCount, nmfs_terminal entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static List<nmfs_terminal> GetPageDataByDic(int currentPageIndex, int pageSize, ref int totalCount, Dictionary<string, object> queryValue, ConditionalType conditionalType = ConditionalType.Equal)
        {
            try
            {
                List<IConditionalModel> conModels = new List<IConditionalModel>();
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static bool Insert(nmfs_terminal entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static bool InsertByList(List<nmfs_terminal> entityList)
        {
            try
            {
        ...
        public static bool Save(nmfs_terminal entity)
        {
            try
            {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static bool Update(nmfs_terminal entity)
        {
            try
            {
        ...
        public static bool DeletePrimaryKey(object primaryKeyValue)
        {
            try
            {
                var res = EntityMgr.Db.Deleteable<nmfs_terminal>().In(primaryKeyValue).ExecuteCommand();
                return res > 0;
            }
            catch (Exception ex)
            {
        ...
        public static bool DeletePrimaryKey(object[] primaryKeyValueArray)
        {
            try
            {
                var res = EntityMgr.Db.Deleteable<nmfs_terminal>().In(primaryKeyValueArray).ExecuteCommand();
                return res > 0;
            }
            catch (Exception ex)
            {
        ...
        /// <param name="strArray"></param>
        /// <returns></returns>
        public static bool DeleteByEntity(nmfs_terminal entity)
        {
            try
            {
        ...
        public static bool DeleteByDic(Dictionary<string, object> queryValue)
        {
            try
            {
                ...
                var res = EntityMgr.Db.Deleteable<nmfs_terminal>()
                    .Where(queryWhereStr)
                  .ExecuteCommand();
                return res > 0;
            }
        ...
        public static bool DeleteAll()
        {
            try
            {
                var res = EntityMgr.Db.DbMaintenance.TruncateTable<nmfs_terminal>();
                return res;
            }
            catch (Exception ex)
            {
        ...
        /// <returns>备注</returns>
        public static bool IsExistSingleDataByEntity(nmfs_terminal entity, out nmfs_terminal returnEntity)
        {
            try
            {
                returnEntity = new nmfs_terminal();
                List<IConditionalModel> conModels = new List<IConditionalModel>();
