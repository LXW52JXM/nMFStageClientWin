...
namespace DBService
{
    public class NmfsParametersService
    {
        private static readonly nmfs_parametersManager EntityMgr = new nmfs_parametersManager();

        /// <summary>
        /// 得到实体类转成Dic
        /// </summary>
        private static Dictionary<string, object> EntityMap = ToMap(new nmfs_parameters());
        ...
        /// </summary>
        /// <returns></returns>
        public static nmfs_parameters GetOneDataByPrimaryKey(object o)
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_parameters>()
                    .InSingle(o);
                return res;
            }
            catch (Exception ex)
        ...
        /// </summary>
        /// <returns></returns>
        public static List<nmfs_parameters> GetDataByNumber(int maxUpDataCount)
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_parameters>()
        ...
        /// </summary>
        /// <returns></returns>
        public static List<nmfs_parameters> GetData()
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_parameters>()
        ...
        /// <returns></returns>
        public static List<nmfs_parameters> GetDataByEntity(nmfs_parameters entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static List<nmfs_parameters> GetDataByDic(Dictionary<string, object> queryValue, ConditionalType conditionalType = ConditionalType.Equal)
        {
            try
            {
                ...
                var res = EntityMgr.Db.Queryable<nmfs_parameters>().Where(conModels)
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static List<nmfs_parameters> GetPageDataByEntity(int currentPageIndex, int pageSize, ref int totalCount, nmfs_parameters entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static List<nmfs_parameters> GetPageDataByDic(int currentPageIndex, int pageSize, ref int totalCount, Dictionary<string, object> queryValue, ConditionalType conditionalType = ConditionalType.Equal)
        {
            try
            {
                List<IConditionalModel> conModels = new List<IConditionalModel>();
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static bool Insert(nmfs_parameters entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static bool InsertByList(List<nmfs_parameters> entityList)
        {
            try
            {
        ...
        public static bool Save(nmfs_parameters entity)
        {
            try
            {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static bool Update(nmfs_parameters entity)
        {
            try
            {
        ...
        public static bool DeletePrimaryKey(object primaryKeyValue)
        {
            try
            {
                var res = EntityMgr.Db.Deleteable<nmfs_parameters>().In(primaryKeyValue).ExecuteCommand();
                return res > 0;
            }
            catch (Exception ex)
            {
        ...
        public static bool DeletePrimaryKey(object[] primaryKeyValueArray)
        {
            try
            {
                var res = EntityMgr.Db.Deleteable<nmfs_parameters>().In(primaryKeyValueArray).ExecuteCommand();
                return res > 0;
            }
            catch (Exception ex)
            {
        ...
        /// <param name="strArray"></param>
        /// <returns></returns>
        public static bool DeleteByEntity(nmfs_parameters entity)
        {
            try
            {
        ...
        public static bool DeleteByDic(Dictionary<string, object> queryValue)
        {
            try
            {
                ...
                var res = EntityMgr.Db.Deleteable<nmfs_parameters>()
                    .Where(queryWhereStr)
                  .ExecuteCommand();
                return res > 0;
            }
        ...
        public static bool DeleteAll()
        {
            try
            {
                var res = EntityMgr.Db.DbMaintenance.TruncateTable<nmfs_parameters>();
                return res;
            }
            catch (Exception ex)
            {
        ...
        /// <returns>备注</returns>
        public static bool IsExistSingleDataByEntity(nmfs_parameters entity, out nmfs_parameters returnEntity)
        {
            try
            {
                returnEntity = new nmfs_parameters();
                List<IConditionalModel> conModels = new List<IConditionalModel>();
