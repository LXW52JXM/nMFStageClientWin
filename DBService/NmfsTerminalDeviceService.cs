...
namespace DBService
{
    public class NmfsTerminalDeviceService
    {
        private static readonly nmfs_terminal_deviceManager EntityMgr = new nmfs_terminal_deviceManager();

        /// <summary>
        /// 得到实体类转成Dic
        /// </summary>
        private static Dictionary<string, object> EntityMap = ToMap(new nmfs_terminal_device());
        ...
        /// </summary>
        /// <returns></returns>
        public static nmfs_terminal_device GetOneDataByPrimaryKey(object o)
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_terminal_device>()
                    .InSingle(o);
                return res;
            }
            catch (Exception ex)
        ...
        /// </summary>
        /// <returns></returns>
        public static List<nmfs_terminal_device> GetDataByNumber(int maxUpDataCount)
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_terminal_device>()
        ...
        /// </summary>
        /// <returns></returns>
        public static List<nmfs_terminal_device> GetData()
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_terminal_device>()
        ...
        /// <returns></returns>
        public static List<nmfs_terminal_device> GetDataByEntity(nmfs_terminal_device entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static List<nmfs_terminal_device> GetDataByDic(Dictionary<string, object> queryValue, ConditionalType conditionalType = ConditionalType.Equal)
        {
            try
            {
                ...
                var res = EntityMgr.Db.Queryable<nmfs_terminal_device>().Where(conModels)
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static List<nmfs_terminal_device> GetPageDataByEntity(int currentPageIndex, int pageSize, ref int totalCount, nmfs_terminal_device entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static List<nmfs_terminal_device> GetPageDataByDic(int currentPageIndex, int pageSize, ref int totalCount, Dictionary<string, object> queryValue, ConditionalType conditionalType = ConditionalType.Equal)
        {
            try
            {
                List<IConditionalModel> conModels = new List<IConditionalModel>();
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static bool Insert(nmfs_terminal_device entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static bool InsertByList(List<nmfs_terminal_device> entityList)
        {
            try
            {
        ...
        public static bool Save(nmfs_terminal_device entity)
        {
            try
            {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static bool Update(nmfs_terminal_device entity)
        {
            try
            {
        ...
        public static bool DeletePrimaryKey(object primaryKeyValue)
        {
            try
            {
                var res = EntityMgr.Db.Deleteable<nmfs_terminal_device>().In(primaryKeyValue).ExecuteCommand();
                return res > 0;
            }
            catch (Exception ex)
            {
        ...
        public static bool DeletePrimaryKey(object[] primaryKeyValueArray)
        {
            try
            {
                var res = EntityMgr.Db.Deleteable<nmfs_terminal_device>().In(primaryKeyValueArray).ExecuteCommand();
                return res > 0;
            }
            catch (Exception ex)
            {
        ...
        /// <param name="strArray"></param>
        /// <returns></returns>
        public static bool DeleteByEntity(nmfs_terminal_device entity)
        {
            try
            {
        ...
        public static bool DeleteByDic(Dictionary<string, object> queryValue)
        {
            try
            {
                ...
                var res = EntityMgr.Db.Deleteable<nmfs_terminal_device>()
                    .Where(queryWhereStr)
                  .ExecuteCommand();
                return res > 0;
            }
        ...
        public static bool DeleteAll()
        {
            try
            {
                var res = EntityMgr.Db.DbMaintenance.TruncateTable<nmfs_terminal_device>();
                return res;
            }
            catch (Exception ex)
            {
        ...
        /// <returns>备注</returns>
        public static bool IsExistSingleDataByEntity(nmfs_terminal_device entity, out nmfs_terminal_device returnEntity)
        {
            try
            {
                returnEntity = new nmfs_terminal_device();
                List<IConditionalModel> conModels = new List<IConditionalModel>();
