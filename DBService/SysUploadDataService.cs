...
namespace DBService
{
    public class SysUploadDataService
    {
        private static readonly sys_upload_dataManager EntityMgr = new sys_upload_dataManager();

        /// <summary>
        /// 得到实体类转成Dic
        /// </summary>
        private static Dictionary<string, object> EntityMap = ToMap(new sys_upload_data());
        ...
        /// </summary>
        /// <returns></returns>
        public static sys_upload_data GetOneDataByPrimaryKey(object o)
        {
            try
            {
                var res = EntityMgr.Db.Queryable<sys_upload_data>()
                    .InSingle(o);
                return res;
            }
            catch (Exception ex)
        ...
        /// </summary>
        /// <returns></returns>
        public static List<sys_upload_data> GetDataByNumber(int maxUpDataCount)
        {
            try
            {
                var res = EntityMgr.Db.Queryable<sys_upload_data>()
        ...
        /// </summary>
        /// <returns></returns>
        public static List<sys_upload_data> GetData()
        {
            try
            {
                var res = EntityMgr.Db.Queryable<sys_upload_data>()
        ...
        /// <returns></returns>
        public static List<sys_upload_data> GetDataByEntity(sys_upload_data entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static List<sys_upload_data> GetDataByDic(Dictionary<string, object> queryValue, ConditionalType conditionalType = ConditionalType.Equal)
        {
            try
            {
                ...
                var res = EntityMgr.Db.Queryable<sys_upload_data>().Where(conModels)
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static List<sys_upload_data> GetPageDataByEntity(int currentPageIndex, int pageSize, ref int totalCount, sys_upload_data entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static List<sys_upload_data> GetPageDataByDic(int currentPageIndex, int pageSize, ref int totalCount, Dictionary<string, object> queryValue, ConditionalType conditionalType = ConditionalType.Equal)
        {
            try
            {
                List<IConditionalModel> conModels = new List<IConditionalModel>();
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static bool Insert(sys_upload_data entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static bool InsertByList(List<sys_upload_data> entityList)
        {
            try
            {
        ...
        public static bool Save(sys_upload_data entity)
        {
            try
            {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static bool Update(sys_upload_data entity)
        {
            try
            {
        ...
        public static bool DeletePrimaryKey(object primaryKeyValue)
        {
            try
            {
                var res = EntityMgr.Db.Deleteable<sys_upload_data>().In(primaryKeyValue).ExecuteCommand();
                return res > 0;
            }
            catch (Exception ex)
            {
        ...
        public static bool DeletePrimaryKey(object[] primaryKeyValueArray)
        {
            try
            {
                var res = EntityMgr.Db.Deleteable<sys_upload_data>().In(primaryKeyValueArray).ExecuteCommand();
                return res > 0;
            }
            catch (Exception ex)
            {
        ...
        /// <param name="strArray"></param>
        /// <returns></returns>
        public static bool DeleteByEntity(sys_upload_data entity)
        {
            try
            {
        ...
        public static bool DeleteByDic(Dictionary<string, object> queryValue)
        {
            try
            {
                ...
                var res = EntityMgr.Db.Deleteable<sys_upload_data>()
                    .Where(queryWhereStr)
                  .ExecuteCommand();
                return res > 0;
            }
        ...
        public static bool DeleteAll()
        {
            try
            {
                var res = EntityMgr.Db.DbMaintenance.TruncateTable<sys_upload_data>();
                return res;
            }
            catch (Exception ex)
            {
        ...
        /// <returns>备注</returns>
        public static bool IsExistSingleDataByEntity(sys_upload_data entity, out sys_upload_data returnEntity)
        {
            try
            {
                returnEntity = new sys_upload_data();
                List<IConditionalModel> conModels = new List<IConditionalModel>();
