...
namespace DBService
{
    public class NmfsFlowRecordsService
    {
        private static readonly nmfs_flow_recordsManager EntityMgr = new nmfs_flow_recordsManager();

        /// <summary>
        /// 得到实体类转成Dic
        /// </summary>
        private static Dictionary<string, object> EntityMap = ToMap(new nmfs_flow_records());
        ...
        /// </summary>
        /// <returns></returns>
        public static nmfs_flow_records GetOneDataByPrimaryKey(object o)
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_flow_records>()
                    .InSingle(o);
                return res;
            }
            catch (Exception ex)
        ...
        /// </summary>
        /// <returns></returns>
        public static List<nmfs_flow_records> GetDataByNumber(int maxUpDataCount)
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_flow_records>()
        ...
        /// </summary>
        /// <returns></returns>
        public static List<nmfs_flow_records> GetData()
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_flow_records>()
        ...
        /// <returns></returns>
        public static List<nmfs_flow_records> GetDataByEntity(nmfs_flow_records entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static List<nmfs_flow_records> GetDataByDic(Dictionary<string, object> queryValue, ConditionalType conditionalType = ConditionalType.Equal)
        {
            try
            {
                ...
                var res = EntityMgr.Db.Queryable<nmfs_flow_records>().Where(conModels)
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static List<nmfs_flow_records> GetPageDataByEntity(int currentPageIndex, int pageSize, ref int totalCount, nmfs_flow_records entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static List<nmfs_flow_records> GetPageDataByDic(int currentPageIndex, int pageSize, ref int totalCount, Dictionary<string, object> queryValue, ConditionalType conditionalType = ConditionalType.Equal)
        {
            try
            {
                List<IConditionalModel> conModels = new List<IConditionalModel>();
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static bool Insert(nmfs_flow_records entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static bool InsertByList(List<nmfs_flow_records> entityList)
        {
            try
            {
        ...
        public static bool Save(nmfs_flow_records entity)
        {
            try
            {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static bool Update(nmfs_flow_records entity)
        {
            try
            {
        ...
        public static bool DeletePrimaryKey(object primaryKeyValue)
        {
            try
            {
                var res = EntityMgr.Db.Deleteable<nmfs_flow_records>().In(primaryKeyValue).ExecuteCommand();
                return res > 0;
            }
            catch (Exception ex)
            {
        ...
        public static bool DeletePrimaryKey(object[] primaryKeyValueArray)
        {
            try
            {
                var res = EntityMgr.Db.Deleteable<nmfs_flow_records>().In(primaryKeyValueArray).ExecuteCommand();
                return res > 0;
            }
            catch (Exception ex)
            {
        ...
        /// <param name="strArray"></param>
        /// <returns></returns>
        public static bool DeleteByEntity(nmfs_flow_records entity)
        {
            try
            {
        ...
        public static bool DeleteByDic(Dictionary<string, object> queryValue)
        {
            try
            {
                ...
                var res = EntityMgr.Db.Deleteable<nmfs_flow_records>()
                    .Where(queryWhereStr)
                  .ExecuteCommand();
                return res > 0;
            }
        ...
        public static bool DeleteAll()
        {
            try
            {
                var res = EntityMgr.Db.DbMaintenance.TruncateTable<nmfs_flow_records>();
                return res;
            }
            catch (Exception ex)
            {
        ...
        /// <returns>备注</returns>
        public static bool IsExistSingleDataByEntity(nmfs_flow_records entity, out nmfs_flow_records returnEntity)
        {
            try
            {
                returnEntity = new nmfs_flow_records();
                List<IConditionalModel> conModels = new List<IConditionalModel>();
