...
namespace DBService
{
    public class NmfsTaskDetailsService
    {
        private static readonly nmfs_task_detailsManager EntityMgr = new nmfs_task_detailsManager();

        /// <summary>
        /// 得到实体类转成Dic
        /// </summary>
        private static Dictionary<string, object> EntityMap = ToMap(new nmfs_task_details());
        ...
        /// </summary>
        /// <returns></returns>
        public static nmfs_task_details GetOneDataByPrimaryKey(object o)
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_task_details>()
                    .InSingle(o);
                return res;
            }
            catch (Exception ex)
        ...
        /// </summary>
        /// <returns></returns>
        public static List<nmfs_task_details> GetDataByNumber(int maxUpDataCount)
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_task_details>()
        ...
        /// </summary>
        /// <returns></returns>
        public static List<nmfs_task_details> GetData()
        {
            try
            {
                var res = EntityMgr.Db.Queryable<nmfs_task_details>()
        ...
        /// <returns></returns>
        public static List<nmfs_task_details> GetDataByEntity(nmfs_task_details entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static List<nmfs_task_details> GetDataByDic(Dictionary<string, object> queryValue, ConditionalType conditionalType = ConditionalType.Equal)
        {
            try
            {
                ...
                var res = EntityMgr.Db.Queryable<nmfs_task_details>().Where(conModels)
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static List<nmfs_task_details> GetPageDataByEntity(int currentPageIndex, int pageSize, ref int totalCount, nmfs_task_details entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static List<nmfs_task_details> GetPageDataByDic(int currentPageIndex, int pageSize, ref int totalCount, Dictionary<string, object> queryValue, ConditionalType conditionalType = ConditionalType.Equal)
        {
            try
            {
                List<IConditionalModel> conModels = new List<IConditionalModel>();
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static bool Insert(nmfs_task_details entity)
        {
            try
            {
        ...
        /// <returns></returns>
        public static bool InsertByList(List<nmfs_task_details> entityList)
        {
            try
            {
        ...
        public static bool Save(nmfs_task_details entity)
        {
            try
            {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public static bool Update(nmfs_task_details entity)
        {
            try
            {
        ...
        public static bool DeletePrimaryKey(object primaryKeyValue)
        {
            try
            {
                var res = EntityMgr.Db.Deleteable<nmfs_task_details>().In(primaryKeyValue).ExecuteCommand();
                return res > 0;
            }
            catch (Exception ex)
            {
        ...
        public static bool DeletePrimaryKey(object[] primaryKeyValueArray)
        {
            try
            {
                var res = EntityMgr.Db.Deleteable<nmfs_task_details>().In(primaryKeyValueArray).ExecuteCommand();
                return res > 0;
            }
            catch (Exception ex)
            {
        ...
        /// <param name="strArray"></param>
        /// <returns></returns>
        public static bool DeleteByEntity(nmfs_task_details entity)
        {
            try
            {
        ...
        public static bool DeleteByDic(Dictionary<string, object> queryValue)
        {
            try
            {
                ...
                var res = EntityMgr.Db.Deleteable<nmfs_task_details>()
                    .Where(queryWhereStr)
                  .ExecuteCommand();
                return res > 0;
            }
        ...
        public static bool DeleteAll()
        {
            try
            {
                var res = EntityMgr.Db.DbMaintenance.TruncateTable<nmfs_task_details>();
                return res;
            }
            catch (Exception ex)
            {
        ...
        /// <returns>备注</returns>
        public static bool IsExistSingleDataByEntity(nmfs_task_details entity, out nmfs_task_details returnEntity)
        {
            try
            {
                returnEntity = new nmfs_task_details();
                List<IConditionalModel> conModels = new List<IConditionalModel>();
