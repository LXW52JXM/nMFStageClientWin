...
{
    public partial class FrmServiceSet : Form
    {
        ...
        private void FrmServcieSet_Load(object sender, EventArgs e)
        {
            try
            {
                TxtUploadDataHttpIp.Text = SystemSet.UploadDataHttpIp;
                TxtUploadDataHttpPort.Text = SystemSet.UploadDataHttpPort.ToString();
                TxtUploadDataSocketIp.Text = SystemSet.UploadDataSocketIp;
                TxtUploadDataSocketPort.Text = SystemSet.UploadDataSocketPort.ToString();
            }
            catch (Exception ex)
            {
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (CheckData())
                {
                    ...
                    SystemSet.UploadDataHttpIp = TxtUploadDataHttpIp.Text.Trim();
                    SystemSet.UploadDataHttpPort = IntHelper.Conversion(TxtUploadDataHttpPort.Text.Trim());
                    SystemSet.UploadDataSocketIp = TxtUploadDataSocketIp.Text.Trim();
                    SystemSet.UploadDataSocketPort = IntHelper.Conversion(TxtUploadDataSocketPort.Text.Trim());
